...
import nate.CountArgumentTypes;
...
//        System.out.println("  check mention " + mention);
        if( !mention.string().equals("_") ) { 
          ...
          Pair<String,Integer> relationIndex = depVerbRelationWithIndex(deps, event, mention);
//          System.out.println("  got relation " + relation);
          if( relationIndex != null && acceptableDependencyAll(relationIndex.first()) ) {
